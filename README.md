...
- `simulation.html`: controllable connected-sector replay with two stable scenarios, equal vehicle load across PATC and fixed-time modes, mixed traffic, queue pressure, severe stops, delay, and completion checks.
