...
- `simulation.html`: controllable connected-sector replay with two stable scenarios, equal vehicle load across PATC and fixed-time modes, movement-group reservations, no-touch vehicle physics, PATC coordination across J/F/S nodes, queue pressure, severe stops, delay, and completion checks.
