...
const gridLinks = [
  [[50, 230], [228, 176], [430, 200], [640, 48], [930, 130], [1535, 96]],
  [[54, 602], [250, 540], [420, 575], [500, 748], [890, 575], [1530, 500]],
...
const routes = {
  ...
  south: {
    ...
    color: colors.cyan,
    laneShift: 8,
    points: [[655, 20], [618, 140], [570, 365], [525, 760]],
    stops: ["J2"],
  },
  north: {
    phase: "NS",
    color: colors.cyan,
    laneShift: -24,
    points: [[470, 760], [516, 540], [570, 365], [502, 22]],
    stops: ["J2"],
  },
  feeder: {
    phase: "EW",
