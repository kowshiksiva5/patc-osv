...
const supportNodes = [
  ...
  { id: "F3", name: "North feeder", x: 500, y: 70 },
  { id: "F4", name: "South feeder", x: 502, y: 580 },
...
const gridLinks = [
  [[40, 210], [180, 178], [360, 190], [500, 70], [760, 122], [1040, 92]],
  [[42, 500], [210, 458], [360, 500], [502, 580], [720, 492], [1045, 430]],
  [[180, 178], [275, 338], [360, 500]],
  [[500, 70], [500, 318], [502, 580]],
...
const routes = {
  ...
  feeder: {
    ...
    color: "#c6ec66",
    laneShift: -8,
    points: [[90, 565], [360, 500], [500, 318], [760, 122], [1040, 52]],
    stops: ["J2"],
  },
};
const scenarios = {
